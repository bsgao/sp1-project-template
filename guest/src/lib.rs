...
use models::{
    LinearRegressionParams, PolynomialRidgeRegressionParams, RidgeRegressionParams, ScalerParams,
    TestData,
};
use predictions::{
    LinearRegressionModel, PolynomialRidgeRegressionModel, RidgeRegressionModel, Scaler,
};
...
sol! {
    struct PublicValuesStruct {
        scaler_path: String,
        linear_model_path: String,
        ridge_model_path: String,
        poly_ridge_model_path: String,
        scaler: Vec<f64>,
        linear_model: Vec<f64>,
        ridge_model: Vec<f64>,
        poly_ridge_model: Vec<f64>,
    }
}
...
//     stack_size = 1844600000000000000,
//     memory_size = 18446000000000000000
// )]
